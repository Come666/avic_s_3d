...
//    String fileName="[]";
//    String contentPath="c:/Users/user/Desktop/scanner/scanner/scan-20171223-175921/textured_mesh.obj";
//    if(contentPath.indexOf("scan-")>0){
//      int index=contentPath.indexOf("scan-");
...
//    System.out.println(fileName);
    ...
    getPresentationName("C:\\Users\\User\\Desktop\\scanner\\scan-20180115-173718\\textured_mesh.obj", ContentType.MODEL);
  }
  
  
  public static String getPresentationName(String contentPath, 
    ...
    switch (contentType) {
      ...
      default :
        ...
        //if scan obj name is textured_mesh.obj need rename yyyyMMDD-hhmmss
        
        String tmpFileName=fileName;
//        if(fileName.indexOf(SweetHomeUtil.DEFAULT_SCAN_OBJ_NAME)>=0 || SweetHomeUtil.DEFAULT_SCAN_OBJ_NAME.equalsIgnoreCase(fileName)){
        if(tmpFileName.indexOf(SweetHomeUtil.DEFAULT_SCAN_OBJ_NAME)>=0){
        ...
        System.out.println("FileContentManager.getPresentationName contentPath:["+contentPath+"] contentType:["+contentType+"] tmpFileName:["+tmpFileName+"] fileName:["+fileName+"]");
        return fileName;
    }    
  }
}
