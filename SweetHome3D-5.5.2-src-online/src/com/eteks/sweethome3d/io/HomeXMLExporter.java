...
public class HomeXMLExporter extends ObjectXMLExporter<Home> {
  ...
  protected class PieceOfFurnitureExporter extends ObjectXMLExporter<HomePieceOfFurniture> { 
    ...
    protected void writeAttributes(XMLWriter writer, HomePieceOfFurniture piece) throws IOException {
      ...
      writer.writeAttribute("scan", String.valueOf(piece.isScan()));
      System.out.println("HomeXMLExporter.PieceOfFurnitureExporter.writeAttributes piece.isScan:["+piece.isScan()+"] piece:["+piece+"] String.valueOf(piece.isScan()):["+String.valueOf(piece.isScan())+"]["+piece.getName()+"]");
   ...
   */
  protected void writeLabel(XMLWriter writer, LabelImage label) throws IOException {
    new ObjectXMLExporter<LabelImage>() {
        @Override
        protected void writeAttributes(XMLWriter writer, LabelImage label) throws IOException {
          ...
          writer.writeAttribute("image_name", label.getImageName());
          System.out.println("writeLabel: image_name:"+label.getImageName());
        } 
        
        @Override
        protected void writeChildren(XMLWriter writer, LabelImage label) throws IOException {
  ...
  private void writeProperties(XMLWriter writer, HomeObject object) throws IOException {
    ...
    System.out.println("HomeXMLExporter.writeProperties  object.getPropertyNames():["+object.getPropertyNames()+"]");
    Collections.sort(propertiesNames);
    for (String propertyName : propertiesNames) {
