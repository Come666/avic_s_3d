...
public class DefaultUserPreferences extends UserPreferences {
  ...
  DefaultUserPreferences(boolean readCatalogs,
    ...
    if (localizedPreferences == null) {
      System.out.println("DefaultUserPreferences localizedPreferences = this;");
      localizedPreferences = this;
    } else {
      System.out.println("DefaultUserPreferences setLanguage(localizedPreferences.getLanguage());");
