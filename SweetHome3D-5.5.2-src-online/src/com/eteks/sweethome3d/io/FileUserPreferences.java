...
public class FileUserPreferences extends UserPreferences {
  ...
  public FileUserPreferences(File preferencesFolder,
    ...
    System.out.println("PortablePreferences portablePreferences = new PortablePreferences();"+(!portablePreferences.exist()
        && preferencesFolder == null)+(  ""+portablePreferences));
    ...
    if (!portablePreferences.exist()
      ...
      System.out.println("use getPreferences()");
      preferences = getPreferences();
    } else {
      System.out.println("use portablePreferences"+portablePreferences);
      preferences = portablePreferences;
    }
    
    String language = preferences.get(LANGUAGE, getLanguage());
    System.out.println("String language = preferences.get(LANGUAGE, getLanguage());"+language);
  ...
  protected Preferences getPreferences() {
    System.out.printf("getPreferences: this.preferences[%s]\n",this.preferences);
    System.out.printf("getPreferences: Preferences.userNodeForPackage(FileUserPreferences.class)[%s]\n",this.preferences);
  ...
  private class PortablePreferences extends AbstractPreferences {
    ...
    private boolean readPreferences() {
      InputStream in = null;
      try {
        System.out.println("new File(getPreferencesFolder(), PREFERENCES_FILE):"+new File(getPreferencesFolder(), PREFERENCES_FILE));
