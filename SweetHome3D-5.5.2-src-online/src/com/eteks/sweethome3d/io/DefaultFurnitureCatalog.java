  ...
  private void readFurniture(ResourceBundle resource, 
    ...
    while (true) {
      ...
      if (ignored == null || !Boolean.parseBoolean(ignored)) {
        System.out.println("defaultfurnitureCatalog readFurniture resource:["+resource+"__"+resource.getBaseBundleName()+"] furnitureCatalogUrl:["+furnitureCatalogUrl+"] furnitureResourcesUrlBase:["+furnitureResourcesUrlBase+"] identifiedFurniture:["+identifiedFurniture+"]");
