...
public class AutoRecoveryManager {
  ...
  public void openRecoveredHomes() {
    ...
    for (Home recoveredHome : this.recoveredHomes) {
      ...
      for (Home home : this.application.getHomes()) {
        ...
        if (home.getName() != null
          ...
          System.out.println("home.getName().equals(recoveredHome.getName())"+recoveredHome.getName());
      ...
      if (!recoveredHomeOpen) {
        System.out.println(i+" openRecoveredHomes recoveredHome.name"+recoveredHome.getName()+"|"+recoveredHome.toString());
        this.application.addHome(recoveredHome);
      }
    ...
    System.out.println("this.recoveredHomes.size:clear start"+this.recoveredHomes.size());
    this.recoveredHomes.clear();
    System.out.println("this.recoveredHomes.size:clear end"+this.recoveredHomes.size());
  }
