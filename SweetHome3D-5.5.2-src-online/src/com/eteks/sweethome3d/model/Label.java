...
public class Label extends HomeObject implements Selectable, Elevatable {
  ...
  protected static final double TWICE_PI = 2 * Math.PI;
   ...
   */
  public enum Property {TEXT, X, Y, ELEVATION, STYLE, COLOR, OUTLINE_COLOR, ANGLE, PITCH, LEVEL, IMAGE_NAME};
  ...
  protected Integer             outlineColor;
