...
public class HomePieceOfFurniture extends HomeObject implements PieceOfFurniture, Selectable, Elevatable {
   ...
   */
  public enum Property {SCAN, NAME, NAME_VISIBLE, NAME_X_OFFSET, NAME_Y_OFFSET, NAME_STYLE, NAME_ANGLE,
   ...
   */
  public enum SortableProperty {SCAN, CATALOG_ID, NAME, WIDTH, DEPTH, HEIGHT, MOVABLE, 
  ...
  public void setScan(boolean scan) {
    System.out.println("HomePieceOfFurniture setScan scan:["+scan+"] this.scan:["+this.scan+"]  scan != this.scan:["+(scan != this.scan)+"]");
    if (scan != this.scan) {
      this.scan = scan;
      
      this.propertyChangeSupport.firePropertyChange(Property.SCAN.name(), !scan, scan);
    }
  }
