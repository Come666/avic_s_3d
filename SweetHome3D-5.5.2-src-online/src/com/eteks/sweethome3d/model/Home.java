...
public class Home implements Serializable, Cloneable {
  ...
  private List<LabelImage>                                 labels;
  private transient CollectionChangeSupport<LabelImage>    labelsChangeSupport;
  ...
  private void moveVisualProperty(String visualPropertyName) {
    if (this.visualProperties.containsKey(visualPropertyName)) {
      ...
      System.out.println("moveVisualProperty:  "+visualPropertyName+":"+value);
  ...
  private void init(boolean newHome) {
    ...
    System.out.println("a home is create"+newHome+this.furnitureVisibleProperties);
    ...
    this.labels = new ArrayList<LabelImage>();
  ...
  private static void initListenersSupport(Home home) {
    ...
    home.labelsChangeSupport = new CollectionChangeSupport<LabelImage>(home);
  ...
  public void deleteLevel(Level level) {
    ...
    if (index != -1) {
      ...
      for (LabelImage label : this.labels) {
   ...
   * @param listener the listener to add
   */
  public void addLabelsListener(CollectionListener<LabelImage> listener) {
   ...
   * @param listener the listener to remove
   */
  public void removeLabelsListener(CollectionListener<LabelImage> listener) {
   ...
   */
  public Collection<LabelImage> getLabels() {
   ...
   */
  public void addLabel(LabelImage label) {
    // Make a copy of the list to avoid conflicts in the list returned by getLabels
    this.labels = new ArrayList<LabelImage>(this.labels);
   ...
   */
  public void deleteLabel(LabelImage label) {
   ...
   * @param items  the items among which the search is done
   */
  public static List<LabelImage> getLabelsSubList(List<? extends Selectable> items) {
    return getSubList(items, LabelImage.class);
  }
