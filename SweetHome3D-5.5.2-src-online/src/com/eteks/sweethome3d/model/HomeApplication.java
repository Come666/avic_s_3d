...
public abstract class HomeApplication {
  ...
  public Home createHome() {
    System.out.println("HomeApplication createHome getUserPreferences().getNewWallHeight()"+getUserPreferences().getNewWallHeight());
    Home home = new Home(getUserPreferences().getNewWallHeight());
    System.out.println("HomeApplication createHome getUserPreferences().getNewWallHeight()   end");
    return home;
  }
  ...
  public void addHome(Home home) {
    ...
    System.out.println(" this.homes.add(home);");
    this.homes.add(home);
    System.out.println(" this.homes.add(home); end");
    
    System.out.println(" this.homesChangeSupport.fireCollectionChanged(home, this.homes.size() - 1, CollectionEvent.Type.ADD); start");
    this.homesChangeSupport.fireCollectionChanged(home, this.homes.size() - 1, CollectionEvent.Type.ADD);
    
    System.out.println("this.homesChangeSupport.fireCollectionChanged(home, this.homes.size() - 1, CollectionEvent.Type.ADD); end");
  }
