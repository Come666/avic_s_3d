...
public abstract class UserPreferences {
  ...
  public UserPreferences() {
    ...
    System.out.println("Locale.getDefault().getLanguage();:"+Locale.getDefault().getLanguage()+"   Locale.getDefault().getCountry():"+Locale.getDefault().getCountry());
    ...
    System.out.println("supportedLanguage:"+this.language);
    updateDefaultLocale();
  }
  ...
  private void updateDefaultLocale() {
    try {
      ...
      System.out.println("updateDefaultLocale Locale.getDefault:"+Locale.getDefault()+"  this.language:"+this.language);
  ...
  public String getLocalizedString(Class<?> resourceClass,
    ...
    System.out.println("classResourceBundle == null"+(classResourceBundle == null));
  ...
  private ResourceBundle getResourceBundle(String resourceFamily) throws IOException {
    ...
    for (String suffix : suffixes) {
      for (ClassLoader classLoader : getResourceClassLoaders()) {
        System.out.println("ResourceBundle getResourceBundle resourceFamily + suffix"+(resourceFamily + suffix));
