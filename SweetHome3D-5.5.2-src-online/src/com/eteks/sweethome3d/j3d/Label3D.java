...
public class Label3D extends Object3DBranch {
  protected static final TransparencyAttributes DEFAULT_TRANSPARENCY_ATTRIBUTES = 
      new TransparencyAttributes(TransparencyAttributes.NICEST, 0);
  protected static final PolygonAttributes      DEFAULT_POLYGON_ATTRIBUTES = 
      new PolygonAttributes(PolygonAttributes.POLYGON_FILL, PolygonAttributes.CULL_NONE, 0, false);
  protected static final TextureAttributes MODULATE_TEXTURE_ATTRIBUTES = new TextureAttributes();
  ...
  protected Transform3D baseLineTransform;
