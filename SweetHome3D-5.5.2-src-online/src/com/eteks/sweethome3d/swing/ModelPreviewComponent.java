...
public class ModelPreviewComponent extends JComponent {
  ...
  private void addMouseListeners(final Component component3D, 
    ...
    for (final MouseListener l : getListeners(MouseListener.class)) {
      component3D.addMouseListener(new MouseListener() {
          ...
          public void mouseClicked(MouseEvent ev) {
            System.out.println("component3D.addMouseListener"+ev);
  ...
  private void createUniverse() {
    ...
    if (this.component3D instanceof Canvas3D) {
      System.out.println("ModelPreviewComponent.createUniverse:this.component3D instanceof Canvas3D");
      canvas3D = (Canvas3D)this.component3D;
    } else {
      try {
        System.out.println("ModelPreviewComponent.createUniverse: else");
  ...
  private BufferedImage getIconImage(int maxWaitingDelay) {
    ...
    System.out.println("getIconImage backgroundColor"+backgroundColor);
    ...
    try {
      ...
      System.out.println("modelPreviewComponent getIconImage this.component3D.getSize():"+this.component3D.getSize());
