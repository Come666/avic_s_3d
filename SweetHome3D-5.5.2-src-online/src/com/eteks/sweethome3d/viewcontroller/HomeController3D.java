...
public class HomeController3D implements Controller {
  ...
  public Point3 getCenterPoint(){
    return ((TopCameraState)topCameraState).getCenterPoint();
  }
  /**
  ...
  private class TopCameraState extends CameraControllerState {
    ...
    private CollectionListener<LabelImage> labelsListener = new CollectionListener<LabelImage>() {
    ...
    public void enter() {
      ...
      for (LabelImage label : home.getLabels()) {
    ...
    public Point3 getCenterPoint(){
      return new Point3((this.aerialViewBoundsLowerPoint [0]+this.aerialViewBoundsUpperPoint [0])/2, (this.aerialViewBoundsLowerPoint [1]+this.aerialViewBoundsUpperPoint [1])/2,(this.aerialViewBoundsLowerPoint [2]+this.aerialViewBoundsUpperPoint [2])/2);
    }
    /**
...
//      System.out.printf("HomeController3D.getCameraToAerialViewCenterDistance aerialViewBoundsLowerPoint 0, 1, 2:[%s,%s,%s]\n", this.aerialViewBoundsLowerPoint [0], this.aerialViewBoundsLowerPoint [1],this.aerialViewBoundsLowerPoint [2]);
//      System.out.printf("HomeController3D.getCameraToAerialViewCenterDistance aerialViewBoundsUpperPoint 0, 1, 2:[%s,%s,%s]\n", this.aerialViewBoundsUpperPoint [0], this.aerialViewBoundsUpperPoint [1],this.aerialViewBoundsUpperPoint [2]);
//      System.out.printf("HomeController3D.getCameraToAerialViewCenterDistance centerPoint 0, 1, 2:[%s,%s,%s]\n", (this.aerialViewBoundsLowerPoint [0]+this.aerialViewBoundsUpperPoint [0])/2, (this.aerialViewBoundsLowerPoint [1]+this.aerialViewBoundsUpperPoint [1])/2,(this.aerialViewBoundsLowerPoint [2]+this.aerialViewBoundsUpperPoint [2])/2);
    ...
    private void updateAerialViewBoundsFromHomeBounds(boolean centerOnSelection) {
      ...
      if (centerOnSelection) { 
        ...
        for (Selectable item : home.getSelectedItems()) {
          if (item instanceof Elevatable 
              ...
              && (!(item instanceof LabelImage)
                  || ((LabelImage)item).getPitch() != null)) {
      ...
      for (LabelImage label : selectionEmpty
                             ? home.getLabels()
    ...
    public void moveCamera(float delta) {
      ...
      System.out.println("HomeController3D moveCamera getCameraToAerialViewCenterDistance:["+getCameraToAerialViewCenterDistance()+ "] delta:["+delta+"]");
