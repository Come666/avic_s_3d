...
public class ImportedFurnitureWizardController extends WizardController 
  ...
  private ImportedFurnitureWizardController(Home home, 
    ...
    setTitle(this.preferences.getLocalizedString(ImportedFurnitureWizardController.class,  piece == null ? "importFurnitureWizard.title"  : "modifyFurnitureWizard.title"));    
    // Initialize states
    ...
    System.out.println("ImportedFurnitureWizardController construct mathod is call");
  }
  ...
  public void finish() {
    ...
    System.out.println("ImportedFurnitureWizardController finish this.category:["+this.category+"]  newPiece:["+newPiece+"]");
    
    if (this.category != null) {
      catalog.add(this.category, newPiece);
    }else if(this.category==null){
      catalog.add(new FurnitureCategory(SweetHomeUtil.DEFAULT_CATEGORY_NAME), newPiece);
    }
  }
  ...
  public void setName(String name) {
    if (name != this.name) {
      ...
      if(name==null || name.trim().length()==0){
         System.out.println("xxxx name is null");
         name = new SimpleDateFormat("yyyyMMdd-HHmmss").format(new Date());
      }
      this.name = name;
      System.out.println("ImportedFurnitureWizard.import furniture name ["+name+"]");
  ...
  public void setCategory(FurnitureCategory category) {
    System.out.println("ImportedFurnitureWizardController.setCategory  this.category:["+this.category+"]  category:["+category+"]");
