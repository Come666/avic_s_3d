...
public interface ViewFactory {
  ...
  /**
   * Returns a new view that displays the different steps that helps the user to
   ...
   * import furniture.
   */
  public abstract ImportedFurnitureWizardStepsView createImportedFurnitureWizardStepsView(CatalogPieceOfFurniture piece,
                                                                                          String modelName,
   ...
   * import a texture.
   */
  public abstract View createImportedTextureWizardStepsView(CatalogTexture texture,
                                                            String textureName,
                                                            UserPreferences preferences,
  ...
  /**
   * Returns a new view able to compute a photos of a home from its stored
   * points of view.
   */
  public abstract DialogView createPhotosView(Home home, UserPreferences preferences, PhotosController photosController);
  ...
  public abstract DialogView createCaseView(UserPreferences preferences ,HomeApplication application, HomeController homeController);
